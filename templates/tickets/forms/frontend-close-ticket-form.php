<form method="POST">
    ...
    <input type="hidden" name="calisia_ticket_close" value="1">
    <button type="submit" class="button mt-20" style="width:100%;"><?php _e('Close Ticket', 'calisia-ticket-system'); ?></button>
</form>